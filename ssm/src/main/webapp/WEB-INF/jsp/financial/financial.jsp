					...
					<table class="table table-striped table-hover table-responsive table-bordered" id="signstautusinfotable">
						<thead>
							<tr>
								<td colspan="14">
									<select id="state">
										<option selected="selected" value="1">待收款</option>
										<option value="2">已收款</option>
										<option value="3">待返款</option>
										<option value="4">待退款</option>
									</select>
									<input type="button" value="查询" class="btn btn-xs btn-default" onclick="search()">
								</td>
							</tr>
							<tr>
								<td colspan="14">
				  ...
				  <div class="panel-body">
				    <div class="container">
			      	...
			      	<div class="container">
			      		...
			      		<div class="row">
			      			<div class="col-md-2">为此次收款备注：<textarea name="remark" rows="3" cols="" placeholder="填写本次所收款项，如学费+住宿费+补贴" required></textarea></div>
			      		</div>
			      	</div>
				  </div>
			  </div>
